import{_ as n,c as a,a2 as p,o as e}from"./chunks/framework.DPDg7N6I.js";const i="/img/Nginx%E5%90%8C%E4%B8%80%E7%AB%AF%E5%8F%A3%E4%B8%8B%E9%83%A8%E7%BD%B2%E5%A4%9A%E4%B8%AAVue3%E9%A1%B9%E7%9B%AE.png",g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"pages/tools/Ngnix.md","filePath":"pages/tools/Ngnix.md"}'),l={name:"pages/tools/Ngnix.md"};function t(c,s,o,r,h,d){return e(),a("div",null,s[0]||(s[0]=[p(`<h2 id="nginx-配置地址转发到-tomcat" tabindex="-1">nginx 配置地址转发到 tomcat <a class="header-anchor" href="#nginx-配置地址转发到-tomcat" aria-label="Permalink to &quot;nginx 配置地址转发到 tomcat&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>	try_files $uri $uri/ /index.html; //https://www.cnblogs.com/boundless-sky/p/9459775.html介绍这个属性的</span></span>
...
<span class="line"><span>表示内容在获取后立即过期，浏览器或缓存服务器必须每次都从源服务器获取内容。</span></span></code></pre></div><h2 id="nginx-同一端口下部署多个-vue3-项目" tabindex="-1">Nginx 同一端口下部署多个 Vue3 项目 <a class="header-anchor" href="#nginx-同一端口下部署多个-vue3-项目" aria-label="Permalink to &quot;Nginx 同一端口下部署多个 Vue3 项目&quot;">​</a></h2><p><img src="`+i+`" alt=""></p><h2 id="nginx-perl-模块代理以及环境变量" tabindex="-1">nginx perl 模块代理以及环境变量 <a class="header-anchor" href="#nginx-perl-模块代理以及环境变量" aria-label="Permalink to &quot;nginx perl 模块代理以及环境变量&quot;">​</a></h2><div class="language-conf vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">conf</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># nginx.conf</span></span>
...
<span class="line"><span># load_module /usr/lib/nginx/modules/ngx_http_perl_module.so;</span></span>
<span class="line"><span># 确保环境变量传递到 Nginx</span></span>
<span class="line"><span>env BYWL_BACKEND_PORT;</span></span>
<span class="line"><span>events {</span></span>
<span class="line"><span>   worker_connections  1024;</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>http {</span></span>
<span class="line"><span></span></span>
<span class="line"><span>   perl_set $backend_port &#39;sub { return $ENV{&quot;BYWL_BACKEND_PORT&quot;}; }&#39;;</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><div class="language-conf vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">conf</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># web.conf</span></span>
<span class="line"><span>server {</span></span>
<span class="line"><span>    listen       80;</span></span>
<span class="line"><span>    server_name  localhost;</span></span>
<span class="line"><span>    client_max_body_size 5G;  # 设置最大上传文件大小为5G</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    location / {</span></span>
<span class="line"><span>         root   /etc/nginx/www/dist;</span></span>
<span class="line"><span>         index  index.html index.htm;</span></span>
<span class="line"><span>         try_files $uri $uri/ /index.html;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>        # 为 index.html 设置单独的缓存策略</span></span>
...
<span class="line"><span>        resolver 127.0.0.11 valid=30s;# Docker 的默认 DNS 服务器  porxy包含变量的时候，需要指定DNS服务器，否则会导致解析失败</span></span>
<span class="line"><span>        proxy_pass http://backend:$backend_port;</span></span>
<span class="line"><span>   }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>   location /env {</span></span>
<span class="line"><span>     default_type text/plain;</span></span>
<span class="line"><span>     return 200 &quot;BACKEND_PORT=$backend_port&quot;;</span></span>
<span class="line"><span>   }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>   error_page   500 502 503 504  /50x.html;</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="nginx-perl-镜像打包" tabindex="-1">nginx perl 镜像打包 <a class="header-anchor" href="#nginx-perl-镜像打包" aria-label="Permalink to &quot;nginx perl 镜像打包&quot;">​</a></h2><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 进入正常nginx:latest镜像容器以后</span></span>
...
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">    perl</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> \\</span></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">    perl-dev</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> \\</span></span>
...
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">    libperl-dev</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> \\</span></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">    zlib1g-dev</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> \\</span></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">    libpcre3-dev</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> \\</span></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">    libssl-dev</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> \\</span></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">    wget</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">cd</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /tmp</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> &amp;&amp; </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">\\</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # 获取最新稳定版本的 Nginx</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    LATEST_NGINX_VERSION</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">$(</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">wget</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -qO-</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> https://nginx.org/en/download.html</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> |</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> grep</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -oP</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;nginx-\\K[0-9.]+(?=\\.tar\\.gz)&#39;</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> |</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> head</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -n</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 1</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">) &amp;&amp; </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">\\</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">    echo</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;Latest Nginx version: </span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">$LATEST_NGINX_VERSION</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> &amp;&amp; </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">\\</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">    wget</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> https://nginx.org/download/nginx-</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">$LATEST_NGINX_VERSION</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">.tar.gz</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> &amp;&amp; </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">\\</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">    tar</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -zxvf</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> nginx-</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">$LATEST_NGINX_VERSION</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">.tar.gz</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> &amp;&amp; </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">\\</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">    cd</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> nginx-</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">$LATEST_NGINX_VERSION</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 查看当前nginx有那些模块</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 编译安装，以下的模块只是perl需要的，nginx -V输出的在编译的时候也要添加上</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">./configure</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --with-http_perl_module</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> \\</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">                --with-http_ssl_module</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> \\</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">                --with-pcre</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> \\</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">                --with-zlib</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> \\</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">                --with-openssl</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> &amp;&amp; </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">\\</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">    make</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> &amp;&amp; </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">\\</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 完成后 nginx -V查看有没有perl模块</span></span></code></pre></div>`,54)]))}const u=n(l,[["render",t]]);export{g as __pageData,u as default};
